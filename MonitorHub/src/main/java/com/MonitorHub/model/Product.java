...
public class Product {
    // Static counter for generating unique IDs (simple in-memory solution)
    ...
    private String type; // e.g., Gaming, Professional
    private int stock_quantity;
    private BigDecimal original_price;
    private BigDecimal discounted_price; // Can be null
    private String delivery_info;

    // Default constructor for frameworks/JSP EL
    public Product() {
        // Initialize with sensible defaults or leave null
        this.original_price = BigDecimal.ZERO; // Avoid NullPointerExceptions in JSP for new products
    }

    // Constructor for creating new products (ID is auto-generated)
    public Product(String name, String brand, String model, String imageUrl, String description,
        ...
        this.id = idCounter.incrementAndGet(); // Assign a new unique ID
        this.name = name;
        this.brand = brand;
        this.model = model;
    ...
    public String getDelivery_info() { return delivery_info; }
    public void setDelivery_info(String delivery_info) { this.delivery_info = delivery_info; }

    // Helper method to get the effective price to display
    ...
    // Helper method to check if there's a valid discount
