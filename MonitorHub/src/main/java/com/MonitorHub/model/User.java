...
public class User implements Serializable {
    ...
    private String roleName; // Store the primary role name for easy access
    private String imageUrl; // Optional: Add field for profile image URL

    // Default constructor
    public User() {
    }

    // Constructor without password hash (useful for session object)
