...
// Removed List and Optional imports as we fetch single object now
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (productIdParam != null && !productIdParam.trim().isEmpty()) {
            try {
                ...
                // You might want to provide less detail to the user in a production environment
            } catch (Exception e) {
