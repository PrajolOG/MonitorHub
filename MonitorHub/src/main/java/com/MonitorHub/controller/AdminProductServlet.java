...
import com.MonitorHub.dao.MonitorDAO; // Import the new DAO
...
@WebServlet(urlPatterns = {"/admin/products", "/admin/products/add", "/admin/products/edit", "/admin/products/save", "/admin/products/delete"}) // Added /delete
public class AdminProductServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;
    private static final Logger LOGGER = Logger.getLogger(AdminProductServlet.class.getName());
    // Removed PRODUCTS_LIST_KEY as we fetch from DB now
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            } else { // Default to "/admin/products" - list products
    ...
    // Removed List<Product> products parameter, fetches from DB
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String action = request.getServletPath();
        String actionParam = request.getParameter("action"); // Check hidden input for delete

        if ("/admin/products/save".equals(action)) {
            handleSavePost(request, response);
        } else if ("/admin/products/delete".equals(action) || "delete".equals(actionParam)) { // Handle delete
