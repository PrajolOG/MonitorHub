...
// Maps to /login for both displaying the form (GET) and processing it (POST)
@WebServlet("/login")
public class LoginServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Avoid forwarding again if an error occurs during forward
        ...
        try {
            ...
            if (rs.next()) {
                ...
                if (PasswordUtil.checkPassword(password, storedHash)) {
                    ...
                    // Forward back to the login page - *** CORRECTED PATH ***
                    request.getRequestDispatcher(LOGIN_VIEW_PATH).forward(request, response);
                    return; // Exit servlet
                }
            } else {
