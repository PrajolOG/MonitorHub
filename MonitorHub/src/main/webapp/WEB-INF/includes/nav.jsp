...
<nav class="navbar">
    ...
    <div class="nav-middle">
        <ul class="nav-links">
            ...
            <li><a href="<%= request.getContextPath() %>/about" class="${requestPath eq '/about' ? 'active' : ''}">About Us</a></li>
            <li><a href="<%= request.getContextPath() %>/contact" class="${requestPath eq '/contact' ? 'active' : ''}">Contact</a></li> <%-- Added Contact Example --%>
        </ul>
    </div>
    ...
    <div class="nav-right">
        <div class="search-container">
            <form action="<%= request.getContextPath() %>/search" method="get" role="search">
                ...
                <input type="search" name="query" placeholder="Search website..." aria-label="Search website">
            </form>
        </div>
