...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/styles/profile.css"> <%-- Keep for general styling --%>

    <%-- Minimal Global Layout Styles (keep as is) --%>
    <style>
        /* Global Body Layout */
        body {
        ...
        /* Status message styling (add if not in auth.css/profile.css) */
        .status-message {
            padding: 12px 18px;
            margin-bottom: 20px;
            border-radius: 5px;
        ...
        @media (max-width: 768px) {
         ...
         /* Adjust spacing if needed after removing image */
         .profile-form {
...
<body>
    ...
    <main class="main-content">
        <div class="profile-container auth-container">
            ...
            <%-- Form posts back to /profile, NO enctype needed --%>
                ...
                <div class="profile-form">
                    ...
                    <div class="input-group">
                     ...
                     <div class="input-group">
                         ...
                         <input type="tel" id="phone" name="phone" value="${sessionScope.user.phone}" placeholder="e.g., +1234567890">
                    </div>
                    <div class="input-group">
                        <label for="email">Email</label>
                        <input type="email" id="email" name="email" value="${sessionScope.user.email}" readonly disabled style="background-color: #e9ecef; cursor: not-allowed;">
            ...
            </form> <%-- End of profile update form --%>
    ...
    <%-- NO JavaScript needed for image preview anymore --%>
