...
<body>
    ...
    <main class="main-content">
                ...
                <c:when test="${not empty productList}">
                    <c:forEach var="product" items="${productList}">
                        <div class="product-card">
                            ...
                            <div class="product-image-container"> <%-- Added a container for relative positioning --%>
                            ...
                            <%-- Conditionally disable button or change text if out of stock --%>
                            <c:choose>
        ...
        <c:if test="${not empty productList && productList.size() > 12}">
