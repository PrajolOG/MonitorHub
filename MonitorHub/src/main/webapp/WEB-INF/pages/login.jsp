...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/styles/auth.css">    <%-- Common Auth Styles --%>
    <%-- No login.css needed for this example --%>

    <%-- Global Layout & Page Specific Styles --%>
    <style>
        /* Global Body Layout */
        body {
        ...
        .main-content { /* Generic wrapper adjusted for auth pages */
             width: 100%;
             margin: 0 auto;
             flex-grow: 1;
             display: flex; /* Use flex defined in auth.css's .main-auth-content */
        ...
        /* The main-auth-content class from auth.css handles centering */

        /* Options Row specific to login */
...
<body>
    ...
    <main class="main-content">
        <div class="main-auth-content"> <%-- Wrapper from auth.css --%>
            <div class="auth-container"> <%-- Container from auth.css --%>
                <h1>Welcome Back</h1>
